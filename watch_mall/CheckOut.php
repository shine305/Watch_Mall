...
<body>
   ...
   <fieldset>
    <legend><h4>Apple Watch Nike</h4></legend>
    <html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<img src="watchphoto/applenike.jpg" width="100%" height="300px">
<table>
    <tr>
        <td>Watch:</td>
    ...
    <tr>
        <td>
            <label class="w3-text-green">Sale Qty:</label>
    ...
    <tr>
        <td colspan="2" align="left"><a href="Check.php">Check Out</a></td>
        <script>
            function calculateAmount(val)
            {
                var tot_price = val * 59800;
...
<form action="">
 ...
 <tr>
                <td colspan="2"><input type="submit" value="Register" name="btncheckout">
...
<div class="flex-container"><div id="dis"> <a href="CheckOut2.php">Next page 1</a></div>
<div id="bis"><a href="CheckOut3.php">Next page 2</a></div></div>
    </form>
